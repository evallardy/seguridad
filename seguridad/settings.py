...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('MYSQL_DATABASE', 'seguridad'),
...
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'seguridad.validators.DefaultPasswordValidator',
    },
    {
...
DEFAULT_INITIAL_PASSWORD = os.environ.get('DEFAULT_INITIAL_PASSWORD', 'Abcd_1234')
